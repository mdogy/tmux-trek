...
The asset list is derived directly from the [gameplay plan](/Users/michael/Documents/dev/tmux-trek/doc/gameplay-plan.md). Anything new in that document should produce a corresponding prompt here. Anything removed from the narrative should be removed (or recast) here.
...
1. Re-read [doc/gameplay-plan.md](/Users/michael/Documents/dev/tmux-trek/doc/gameplay-plan.md) end-to-end.
