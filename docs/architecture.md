...
_Authoritative technical reference. Last consolidated July 12, 2026._
...
| -------------------- | ------------------------------- | --------------------------------------------------------------------------------------------------------------------------------- |
| Game engine          | **Phaser 4** (`phaser`)         | Scenes, tile rendering, camera, tweens, input. `Phaser.AUTO` renderer, `pixelArt: true`, `Scale.FIT` into a responsive 4:3 shell. |
